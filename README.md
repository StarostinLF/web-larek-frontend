...
Класс представляет форму оформления заказа с выбором способа оплаты.

Методы / свойства класса:

- `constructor` — принимает `HTML`-элемент и объект событий для обработки действий;
- `_card` — элемент оплаты картой;
- `_cash` — элемент оплаты наличными;
- `address` — элемент счетчика товаров в корзине;
- `email` — каталога товаров;
- `phone` — обертка страницы.
